...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
    <header class="bg-violet-300 h-20 border-2 border-violet-600 rounded-md p-1">
        <p class="text-center text-lg text-blue-500">hello </p>
    </header>

    <div class="grid grid-cols-3 m-2 gap-2 grid-flow-dense">
        <div class="  rounded-full bg-blue-500 row-span-2 grid grid-cols-3 m-2 gap-2 p-5">
            <?php $locaties = "rounded-full bg-pink-500"; ?>
        ...
        <div class="h-16  rounded-full bg-violet-500 "></div>
        <div class="h-16  rounded-full bg-pink-500 "></div>
        <div class="h-16  rounded-full bg-green-500 "></div>
        <div class="h-16  rounded-full bg-yellow-500"></div>
        <div class="h-16  rounded-full bg-red-500 col-span-3"></div>
        <div class="h-16  rounded-full bg-orange-500 col-span-2"></div>
